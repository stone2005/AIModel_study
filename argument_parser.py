...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--gui', type=str, default='false', help='gui interface. Default is False')
        self.parser.add_argument('--service', type=str, default='false', help='restful service. Default is False')
